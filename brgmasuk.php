...
$brgmasuk = query("SELECT * FROM brgmasuk");
...
if (isset($_POST['edit'])) {
    ...
    $lihatstock = mysqli_query($con, "select * from brg where idx='$idx'"); //lihat stock barang itu saat ini
    $stocknya = mysqli_fetch_array($lihatstock); //ambil datanya
    $stockskrg = $stocknya['stok']; //jumlah stocknya skrg

    $lihatdataskrg = mysqli_query($con, "select * from brgmasuk where id='$id'"); //lihat qty saat ini
    ...
    if ($jumlah >= $qtyskrg) {
        ...
        $queryx = mysqli_query($con, "update brg set stok='$tambahistock' where idx='$idx'");
        $updatedata1 = mysqli_query($con, "update brgmasuk set tanggal='$tanggal',jumlah='$jumlah' where id='$id'");
        ...
        if ($updatedata1 && $queryx) {
            ...
            <meta http-equiv='refresh' content='3; url= brgmasuk.php'/> ";
        };
    } else {
        ...
        $query1 = mysqli_query($con, "update brg set stok='$kurangistock' where idx='$idx'");

        $updatedata = mysqli_query($con, "update brgmasuk set tanggal='$tanggal', jumlah='$jumlah' where id='$id'");
...
if (isset($_POST['hapus'])) {
    ...
    $del = mysqli_query($con, "delete from brgmasuk where id='$id'");
...
<body>
    ...
    <div class="d-sm-flex justify-content-between align-brgs-center">
        <a href="laporanbrgmasuk.php" target="_blank" class="btn btn-info">Print</a>
    ...
    <table class="table table-hover" style="position: relative; top:80px;" id="dataTable3">
        ...
        <tbody>
            <?php
            $brg = mysqli_query($con, "SELECT * from brgmasuk sb, brg st where st.idx=sb.idx order by sb.id DESC");
            $no = 1;
                        ...
                        <div class="modal-content">
                            <form method="post">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="ubahModalLabel">Edit Barang Masuk</h5>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <form method="post">
                                ...
                                <!-- Modal body -->
                                <div class="modal-body">
                                    Apakah Anda yakin ingin menghapus data ini dari daftar barang masuk?
                                    <br>
    ...
    <div id="myModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="brgmasuktambah.php" method="post">
