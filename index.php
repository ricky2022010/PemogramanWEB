...
<body>
    ...
    <div class="jumbotron jumbotron-fluid text-center">
        <div class="container">
            ...
            <hr>
            <p class="lead font-weight-bold" style="color: #80ced6;">Menu Angkringan RA saat ini <br></p>
        </div>
    </div>
    <!-- Akhir Jumbotron -->
    ...
    <div class="container">
        <div class="judul text-center mt-5">
            <h3 class="font-weight-bold">ANGKRINGAN RA</h3>
            <h5>Simpang nato, depan ruko glory star
                <br>Buka dari jam <strong>16:00 - 02:30</strong>
            </h5>
        </div>
            ...
            <div class="row mx-0 mt-5">
                ...
                <?php foreach ($brg as $b) : ?>
                    <div class="col-2 pl-0">
                        <div class="card">
                            <img src="images/<?= $b["foto"] ?>" class="card-img-top" alt="...">
                            <div class="card-body">
                                <h6 class="card-title"><?= $b["nama_barang"] ?></h6>
                                <h6 class="mt-1">Harga</h6>
                                <h6 class="mt-1"><?= $b["harga"] ?></h6>
                            </div>
                        </div>
                    </div>
                    <?php $i++; ?>
